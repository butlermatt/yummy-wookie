...
xr:[function(a){return C.b.bk(a.gat(),U.h2())},"$1","lb",2,0,36],
...
"^":"",
l3:function(a,b,c){return B.kM(A.uV(a,null,c))}}],["","",,G,{
"^":"",
xx:[function(){$.aP=$.$get$kA()
return Y.ed()},"$0","l2",0,0,1]},1]]
setupProgram(dart,0)
...
if(typeof dartMainRunner==="function")dartMainRunner(function(b){H.lf(G.l2(),b)},[])
else (function(b){H.lf(G.l2(),b)})([])})})()